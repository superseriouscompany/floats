  ...
  render() { return (
    <View style={styles.container}>
      <View style={[styles.inputContainer]}>
        <TextInput style={[styles.input]} placeholder="gauge interest" placeholderTextColor={base.colors.mediumgrey} underlineColorAndroid={'transparent'} onChangeText={(text) => this.setState({text})}/>
      </View>
      { this.state.sending ?
        <ActivityIndicator
